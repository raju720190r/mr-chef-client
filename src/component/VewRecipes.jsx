...
const VewRecipes = () => {
    ...
    return (
        <>
            ...
            <div className='py-24 bg-zinc-500 flex px-20 items-center'>
                <div className='w-1/4'>
                    <img src={image} className='h-[350px]' alt="" />
                </div>
                <div className='w-2/4'>
                    <h2 className='text-white text-5xl font-bold mb-3 tracking-[0.4em]'>
                        {name}
                    </h2>
                    <p className='text-zinc-100 font-popins'> {experience}</p>
